...
const App = () => {
  ...
  const skills = {
    ...
    languages: [
      ...
      { name: "Francés", level: "Intermedio-Bajo" }
    ]
  };
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <button onClick={() => window.open(`${import.meta.env.BASE_URL}cv.pdf`, '_blank')} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-medium transition-all shadow-lg shadow-blue-200 flex items-center gap-2">
